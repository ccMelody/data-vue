...
<script>
import { NavCanvas } from "./nav-canvas";//导航tab上面的动效
export default {
  data () {
    return {
      nc: null,
      navs: [
        {icon: 'el-icon-menu',name: '大屏管理'},
        {icon: 'el-icon-location-information',name: '地图管理'}, 
        {icon: 'el-icon-folder-opened',name: '分类管理'}, 
        {icon: 'el-icon-set-up',name: '数据源管理'}, 
        {icon: 'el-icon-document',name: '接口文档'}, 
        // {icon: 'el-icon-document',name: '在线文档'}
      ],
      activeNav: null,
      activeIndex: 0,
    }
