...
<script>
import { getList, updateObj, delObj, getCategory, copyObj } from '@/api/visual';//各接口
import { getObj } from '@/api/visual';//导出的接口
import { viewHtml } from '@/utils/html';//导出展示页面的方法
export default {
  name: "list",
  data () {
    return {
