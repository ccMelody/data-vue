  ...
  <div class="build">
    ...
    <div class="app" :class="{'app--none':!menuFlag}">
      ...
      <div ref="section" class="section">
        ...
        <sketch-rule :thick="thick" :scale="scale"
          :width="width" :height="height"
          :startX="startX" :startY="startY"
          :isShowReferLine="isShowReferLine"
          :palette="palette" :shadow="shadow"
          :horLineArr="lines.h" :verLineArr="lines.v" />
        <div ref='screensRef' id="screens" :class="dragSlide?'dragghanle':''"
            ...
            <el-form label-width="120px" label-position="left" size="mini">
              ...
              <template v-else-if="isSelectActive">
                ...
                <el-form-item label-width="0">
                  <el-button type="primary" size="mini" class="block" @click="handleDeleteSelect">删除</el-button>
                </el-form-item>
                <el-form-item label-width="0">
                  <el-button type="danger" size="mini" class="block" @click="handleFloder">成组</el-button>
                </el-form-item>
              </template>
              <!-- 主屏的配置项 -->
              <template v-else>
                ...
                <el-form-item label="背景图片">
                  <img :src="config.backgroundImage" @click="handleOpenImg('config.backgroundImage','background')"
                       alt="" width="100%" />
                </el-form-item>
...
import layer from './group/layer';//左侧显示的已选中的组件list
import top from './group/top';//可选择的操作栏 
import headers from './group/header';//头部的保存预览等功能按钮
import imglist from './group/imglist';//选择背景图片or上传背景图片的弹出层的组件
...
import SketchRule from "vue-sketch-ruler";//画布的标尺
